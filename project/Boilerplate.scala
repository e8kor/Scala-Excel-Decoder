...
object Boilerplate {
  ...
  object GenTupleDecoders extends Template {
    ...
    def filename(root: File): File = root / "excel" / "decoder" / "TupleDecoders.scala"
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        ...
        |
        |private[excel] trait TupleDecoders {
        -  /**
        -   * @group Tuple
        -   */
  ...
  object GenTupleEncoders extends Template {
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        |package excel
        |
        |private[excel] trait TupleEncoders {
        -  /**
        -   * @group Tuple
        -   */
  ...
  object GenTupleTests extends Template {
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        |package excel
        |
        |import excel.testing.CodecTests
        |import excel.tests.CirceSuite
        |
  ...
  object GenProductDecoders extends Template {
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        |package excel
        |
        |private[excel] trait ProductDecoders {
        -  /**
        -   * @group Product
        -   */
  ...
  object GenProductEncoders extends Template {
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        |package excel
        |
        |private[excel] trait ProductEncoders {
        -  /**
        -   * @group Product
        -   */
  ...
  object GenProductTests extends Template {
    ...
    def filename(root: File): File = root / "excel" / "parser" / "ProductCodecSuite.scala"
    ...
    def content(tv: TemplateVals): String = {
      ...
      block"""
        ...
        |import excel.parser.testing.CodecTests
        |import excel.parser.tests.CirceSuite
